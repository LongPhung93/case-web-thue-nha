                                        ...
                                        <div class="rent-house">
                                            @if (\Illuminate\Support\Facades\Session::has('thongbao'))
                                                <div class="alert alert-danger">
                                                    <strong>{{ \Illuminate\Support\Facades\Session::get('thongbao') }}</strong>
                                                </div>
                                            @endif
                                            <h5>Xác nhận</h5>
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input readonly class="form-control" type="text" name="checkIn" value="{{ Session::get('userRent')['checkIn'] }}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input readonly class="form-control" type="text" name="checkOut" value="{{ Session::get('userRent')['checkOut'] }}" />
                                                ...
                                                <div class="form-group">
                                                    <label for=""><b>Tổng số tiền: {{ number_format($totalPrice,0,",",".") }} VNĐ ({{ $bookDay }} ngày)</b></label>
