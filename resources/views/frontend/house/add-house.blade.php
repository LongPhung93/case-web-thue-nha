                    ...
                    <div class="box-add-house">
                        ...
                        <form action="" method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" autofocus placeholder="" name="name" value="{{ old('name') }}">
                            ...
                            <div class="form-group">
                                <label class="">Địa chỉ (* Vui lòng nhập địa chỉ chi tiết):</label>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control " name="typeRoom">
                                    ...
                                    <option value="Phòng víp">Phòng VIP</option>
                                </select>
                            ...
                            <div class="text-center">
                                <button  type="submit" class="btn btn-primary text-center">Đăng</button>
                            </div>
